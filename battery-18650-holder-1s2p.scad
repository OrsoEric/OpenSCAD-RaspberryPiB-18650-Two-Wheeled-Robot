...
(
	...
	ilk_tab_spring_compression = 0.85,
	//Rails
	iw_tab_rail = 1.75,
...
)
{
	...
	l_total = il_18650 * 1 + it_cap_back + it_tab_button_positive + il_tab_spring + it_cap_back;
...
//holder_18650_1s2p( ix_show_battery = false, ix_show_tab = true );

//holder_18650_1s2p( ix_show_battery = true, ix_show_tab = true );
